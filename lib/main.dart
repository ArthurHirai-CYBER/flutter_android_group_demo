...
class TeamAndroidHomePage extends StatelessWidget {
  ...
  static const String projectTitle = '峰雪小组 Android 真机运行展示';
  static const String projectSlogan = '用 GitHub 协作完成一次 Flutter 应用真机运行实验';
  ...
  static const List<TeamMember> members = [
    TeamMember(
      role: '组长',
      name: '张智阳',
      task: '创建仓库、维护 main、审核 PR、组织主电脑和主手机完成真机运行',
    ),
    TeamMember(
      role: '组员 A',
      name: '郇志轩',
      task: '修改应用标题 projectTitle 和项目口号 projectSlogan',
    ),
    TeamMember(role: '组员 B', name: '李牧凡', task: '补充 members 中的小组成员姓名与分工'),
    TeamMember(role: '组员 C', name: '李响', task: '补充 androidTasks 中的真机运行检查任务'),
    TeamMember(
      role: '组员 D',
      name: '庞博',
      task: '补充 evidenceNotes 中的拍照和 README 证据说明',
    ),
  ];
  ...
  static const List<String> evidenceNotes = [
    ...
    '清理通知栏，避免隐私信息。',
    '照片需清晰展示 App 界面运行在真机屏幕上，不可模糊或遮挡应⽤标题或⼩组信息等关键内容。',
    '拍摄时确保手持手势自然，能明确看出是真人手持真机。',
    'README 中应单独设立"真机运行证据"章节，展示真机照片。',
  ];
